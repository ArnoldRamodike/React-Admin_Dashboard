...
const userSchema = yup.object().shape({
   firstName: yup.string().required("Required String"),
   LastName: yup.string().required("Required String"),
   email: yup.string().email("Invalid Email").required("Required String"),
   contact: yup.string().required("Required Number"),
   address1: yup.string().required("Required String"),
   address2: yup.string().required("Required String"),
})
            ...
            {({values, errors, touched, handleBlur, handleChange, handleSubmit}) =>(
                <form onSubmit={handleSubmit}>
                    ...
                    sx={{"& > div": {gridColumn: isNonMobile ? undefined : "span 4"},}} >
                        <TextField fullWidth variant="filled" type="text" label="Firt Name" onBlur={handleBlur} onChange={handleChange}
                        ...
                        sx={{gridColumn: "span 4"}}/>
                        <TextField fullWidth variant="filled" type="text" label="Address1" onBlur={handleBlur} onChange={handleChange}
                        value={values.address1} name="address1" error={!!touched.address1 && !!errors.address1} 
                        helperText={touched.address1 && errors.address1}
                        sx={{gridColumn: "span 2"}}/>
                        <TextField fullWidth variant="filled" type="text" label="Address2" onBlur={handleBlur} onChange={handleChange}
